...
<div class="min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">لطفاً فرم زیر را تکمیل کنید</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" class="form-input w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="نام و نام خانوادگی" required>
                @error('name')
            ...
            <div class="mb-6">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" class="form-input w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="********" required>
            </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-gray-600">قبلاً ثبت‌نام کرده‌اید؟
                    <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800">وارد شوید</a>
                </p>
            </div>
        </form>
    </div>
